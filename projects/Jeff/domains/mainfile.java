...
public class mainfile {
	...
	public static void main(String[] args) throws Exception, IOException {
		...
		for (int i=0; i<arrayurl.length; i++){
			...
			// lets try if its broken
			URL urlz = new URL(entryurl);
			HttpURLConnection connection = (HttpURLConnection)urlz.openConnection();
			connection.setRequestMethod("GET");
			connection.connect();
			int code = connection.getResponseCode();
			// end of lets try if its broken
		...
		//	System.out.println(domain+path);
			...
			if (a.equals(b) && q == null){System.out.println(entryurl+",site,");}
				...
				System.out.println(entryurl+ ",broken");
